...
fun WhitelistDomainScreen(
    ...
    val filteredDomains = remember(whitelistDomains, searchQuery) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Column {
                        Text(
                            stringResource(R.string.whitelist_domains_title),
                            fontWeight = FontWeight.Bold
                        )
                        Text(
                            stringResource(
                                R.string.whitelist_domains_subtitle
                            ),
        ...
        Column(
            ...
            // Domain count
            Text(
                text = "${filteredDomains.size} ${stringResource(R.string.settings_whitelist_domains).lowercase()}",
            ...
            if (filteredDomains.isEmpty()) {
                ...
                Box(
                    ...
                    Column(
                        ...
                        Text(
                            stringResource(R.string.whitelist_domains_empty),
